...
const char aszAUTHORS[] =
    ...
    "\n"
    "    Olivier Baur            Isaac Keslassy          Nikolas Nyby\n"
    "    Holger Bochnig          Kaoru Takahashi         Rod Roark\n"
    "    Guido Flohr             Stein Kulseth           Aaron Tikuisis\n"
    "    Nis Joergensen          Ingo Macherius\n"
    "    Petr Kadlec             Jeremy Moore\n"
    "\n"
    "                            Translations by:\n"
    "\n"
    "     Petr Kadlec (Czech)\n"
    ...
    "\n"
    "    Russ Allbery            Martin Janke            James Rech\n"
    "    Misja Alma              Neil Kazaross           Jared Riley\n"
    "    Kazuaki Asai            Mathias Kegelmann       Klaus Rindholt\n"
    "    Eric Augustine          Matija Kejzar           Oliver Riordan\n"
    "    Erik Barfoed            Bert Van Kerckhove      Alex Romosan\n"
    "    Ron Barry               James F. Kibler         Hans-Juergen Schaefer\n"
    "    Steve Baedke            Johnny Kirk             Steve Schreiber\n"
    "    Stefan van den Berg     Gerhard Knop            Hugh Sconyers\n"
    "    Frank Berger            Robert Konigsberg       Martin Schrode\n"
    "    Jim Borror              Martin Krainer          Paul Selick\n"
    "    Chuck Bower             Elias Kritikos          Sho Sengoku\n"
    "    Adrian Bunk             Corrin Lakeland         Ian Shaw\n"
    "    Nick Bratby             Tim Laursen             Alberta di Silvio\n"
    "    Craig Campbell          Myshkin LeVine          Peter Sochovsky\n"
    "    Timothy Chow            Eli Liang               Mark Spencer\n"
    "    John Chuang             Ege Lundgren            Scott Steiner\n"
    "    Tristan Colgate         Kevin Maguire           Maik Stiebler\n"
    "    Olivier Croisille       Massimiliano Maini      W. Stroop (Rob)\n"
    "    Ned Cross               Giulio De Marco         Daisuke Takahashi\n"
    "    Ian Curtis              John Marttila           Yoshito Takeuchi\n"
    "    Bill Davidson           Alix Martin             Jacques Thiriat\n"
    "    Michael Depreli         Tom Martin              Malene Thyssen\n"
    "    Ian Dunstan             William Maslen          Claes Tornberg\n"
    "    Max Durbano             Joachim Matussek        Sander van Rijnswou\n"
    "    Peter Eberhard          Thomas Meyer            Robert-Jan Veldhuizen\n"
    "    Robert Eberlein         Daniel Murphy           Morten Wang\n"
    "    Fotis                   Magnar Naustdalslid     Jeff White\n"
    "    Dan Fandrich            Dave Neary              JP White\n"
    "    Kennedy Fraser          Rolf Nielsen            Mike Whitton\n"
    "    Ric Gerace              Mirori Orange           Chris Wilson\n"
    "    Michel Grimminck        Peter Orum              Simon Woodhead\n"
    ...
    "    Casey Hopkins           Sam Pottle              Tilemachos Zoidis\n"
    "    Naoki Iketani           Henrik Ravn             Louis Zulli\n"
    "\n"
    "\n"
